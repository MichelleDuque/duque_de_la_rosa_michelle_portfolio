...
<head>
    ...
    <script defer type="module" src="js/add_contact.js"></script>
...
<body>
    ...
    <main>
        <section class="grid-con">
            ...
            <div class="col-span-full m-col-span-full l-col-span-full xl-col-span-full" id="received-html">
                <div>
                <a><span id="close-received-html">&times;</span></a>
                </div>
                <div id="text-received-html">
                    <h2>PERFECT!</h2>
                    <h3> You Have Chosen Wisely</h3>
                </div>
            </div>
